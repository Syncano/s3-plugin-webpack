	...
	module.exports = function () {
	  function S3Plugin() {
	    ...
	    var include = options.include,
	        ...
	        _options$indexOptions = options.indexOptions,
	        indexOptions = _options$indexOptions === undefined ? {} : _options$indexOptions,
	        _options$gzipOptions = options.gzipOptions,
	        gzipOptions = _options$gzipOptions === undefined ? {} : _options$gzipOptions,
	        _options$cacheOptions = options.cacheOptions,
	        cacheOptions = _options$cacheOptions === undefined ? {} : _options$cacheOptions;
